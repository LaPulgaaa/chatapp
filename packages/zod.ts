...
export const user_signup_form_schema = z.object({
  username: z
    ...
    .min(8, { message: "username must atleast be 8 characters" })
    .max(20),
  ...
  password: z
    ...
    .min(10, { message: "Password should atleast be 10 characters" })
    .max(14),
});
...
export const message_schema = z.object({
  ...
  message: z
    .string()
    .max(50, { message: "can not send message of length more than 50." }),
});
...
export const user_chats_response_schema = z.array(user_chat_schema);
...
export const room_member_details_schema = z.array(
  z.object({
    username: z.string(),
    name: z.string().nullish(),
    active: z.boolean(),
...
export const friend_search_result_schema = z
  .discriminatedUnion("is_friend", [
    z.object({
...
export const message_star_payload = message_pin_payload
  .omit({ pinned: true })
