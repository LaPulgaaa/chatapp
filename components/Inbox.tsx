...
export default function Inbox({data}:{data:UnitMessage}){
    ...
    return <div className={`flex m-2 ${data.sender.username===username?'justify-end':data.sender.username===''?' justify-center':''}  `}>
    ...
    <div className={`border-2 pb-2 bg-slate-200 dark:bg-slate-900 mr-2 p-2 pl-4 max-w-prose rounded-md flex`}>
